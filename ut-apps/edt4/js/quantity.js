...
(function() {
    ...
    Quantity.create = function(scalar, unit) {
        ...
        unit = (unit === undefined ? DIMENSIONLESS : unit);
    ...
    Quantity.pp = function(q, label) {
        if (label)
            console.log(label + ': ' + q.scalar + ' ' + q.unit);
        else
            console.log('Quantity.pp: ' + q.scalar + ' ' + q.unit);
    };
    ...
    Quantity.multiply = function(q1, q2, result) {
        ...
        result = (result === undefined ? Quantity.create() : result);
