...
//        this.fix_rows();
    ...
    Model.prototype.coerce_variable_value = function(variable, value) {
        value = use_default(value, variable.value);
...
//        this.rows = [];
    ...
    Design.prototype.reset = function(rows, cols) {
        rows = use_default(rows, []);
        cols = use_default(cols, []);
    ...
    Design.prototype.pretty_print = function(label) {
        ...
        printf('================================================');
        printf('Design.pretty_print ' + label);
        printf('===================');
        var str = 'Columns ';
...
//        }
    ...
    Design.prototype.check_specified = function() {
        ...
        var i_min = use_default(conf.independent.minimum, 1);
        var i_max = use_default(conf.independent.maximum, null);
        var c_min = use_default(conf.control.minimum, 1);
        var c_max = use_default(conf.control.maximum, null);

        //  Backwards compatibility
        if (!conf.dependent)
            conf.dependent = conf.measure;

        var d_min = use_default(conf.dependent.minimum, 1);
        var d_max = use_default(conf.dependent.maximum, null);
        var v_min = use_default(conf.variable.minimum, 1);
        var v_max = use_default(conf.variable.maximum, null);
