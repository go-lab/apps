...
(function() {
    ...
    Model.prototype.compute_time_spent = function(phase_ranges) {
        ...
        for (var i=0; i<phase_ranges.length; i++) {
            ...
            if (phase === null) {
                printf(i + ' skipping null phase (gap)');
                continue;
            }
            ...
            printf(i + ' ' + phase + ' ' + enter + ' ' + exit + ' ' + interval);
            ...
            if (!phase_agg[phase])
                ...
                printf('adding ' + interval + ' to ' + phase + ' ' + phase_agg[phase].millis);
            }
        }
        ...
        for (var i=0; i<phase_ranges.length; i++) {
            ...
            if (prev_end) {
                if (pc.exit - prev_end > (120*60*1000)) {
                    printf('TIME GAP LARGER THAN 2 HOURS RESETTING');
                    rval = [];
                }
            }
