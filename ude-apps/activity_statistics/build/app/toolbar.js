...
(function (activityStatistics) {
    ...
    function Toolbar(container, languageHandler, options) {
        ...
        var actionLinkClickEvents = activityStatistics.PubSub();
        ...
        function actionLink(actionName, msgKey, glyphiconKey) {
            var msg = activityStatistics.util.escapeHTML(languageHandler.getMessage(msgKey));
            var link = $('<activityStatistics href="#"></activityStatistics>').append($('<span aria-hidden="true" class="glyphicon glyphicon-' + glyphiconKey + '"></span>'));
