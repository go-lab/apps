((ReflectionPoll) => {
    const { Poll, util } = ReflectionPoll;
    const { List: IList, Map: IMap } = Immutable;

    ReflectionPoll.pollTemplates = function(getMsg) {
        const createPoll = (heading, items) => {
            const poll = Poll
            .newPoll()
            .set('items', IList(items).map((item) => {
                return Poll.newItem(
                    item.type,
                    getMsg(item.question),
                    IList(item.answers).map(getMsg).map(Poll.newAnswer)
                );
            }))
            .set('heading', getMsg(heading))
            .set('id', util.uuid());
        ...
        return IMap({
            'emotion': createPoll('poll_emotion_heading', [{
                ...
                answers: [
                    'poll_emotion_mc_2_answer_1',
                    'poll_emotion_mc_2_answer_2',
                    'poll_emotion_mc_2_answer_3',
                    'poll_emotion_mc_2_answer_4',
                    'poll_emotion_mc_2_answer_5'
                ]
            }, {
                type: 'open',
                ...
                answers: [
                    'poll_emotion_mc_1_answer_1',
                    'poll_emotion_mc_1_answer_2',
                    'poll_emotion_mc_1_answer_3',
                    'poll_emotion_mc_1_answer_4',
                    'poll_emotion_mc_1_answer_5'
                ]
            }, {
                type: 'smiley',
            ...
            'ambiguity': createPoll('poll_ambiguity_heading', [{
                ...
                answers: [
                    'poll_ambiguity_mc_2_answer_1',
                    'poll_ambiguity_mc_2_answer_2',
                    'poll_ambiguity_mc_2_answer_3',
                    'poll_ambiguity_mc_2_answer_4',
                    'poll_ambiguity_mc_2_answer_5'
                ]
            }, {
                type: 'smiley',
                ...
                answers: [
                    'poll_ambiguity_mc_1_answer_1',
                    'poll_ambiguity_mc_1_answer_2',
                    'poll_ambiguity_mc_1_answer_3',
                    'poll_ambiguity_mc_1_answer_4',
                    'poll_ambiguity_mc_1_answer_5'
                ]
            }, {
                type: 'open',
            ...
            'groupwork': createPoll('poll_groupwork_heading', [{
                ...
                answers: [
                    'poll_groupwork_mc_2_answer_1',
                    'poll_groupwork_mc_2_answer_2',
                    'poll_groupwork_mc_2_answer_3',
                    'poll_groupwork_mc_2_answer_4',
                    'poll_groupwork_mc_2_answer_5'
                ]
            }, {
                type: 'single-choice',
                ...
                answers: [
                    'poll_groupwork_mc_1_answer_1',
                    'poll_groupwork_mc_1_answer_2',
                    'poll_groupwork_mc_1_answer_3',
                    'poll_groupwork_mc_1_answer_4',
                    'poll_groupwork_mc_1_answer_5'
                ]
            }, {
                type: 'single-choice',
            ...
            'individual_performance': createPoll('poll_individual_performance_heading', [{
                ...
                answers: [
                    'poll_individual_performance_mc_2_answer_1',
                    'poll_individual_performance_mc_2_answer_2',
                    'poll_individual_performance_mc_2_answer_3',
                    'poll_individual_performance_mc_2_answer_4',
                    'poll_individual_performance_mc_2_answer_5'
                ]
            }, {
                type: 'multiple-choice',
                question: 'poll_individual_performance_mc_question_1',
                answers: [
                    'poll_individual_performance_mc_1_answer_1',
                    'poll_individual_performance_mc_1_answer_2',
                    'poll_individual_performance_mc_1_answer_3',
                    'poll_individual_performance_mc_1_answer_4',
                    'poll_individual_performance_mc_1_answer_5'
                ]
            }, {
                type: 'single-choice',
            ...
            'motivation': createPoll('poll_motivation_heading', [{
                ...
                answers: [
                    'poll_motivation_mc_2_answer_1',
                    'poll_motivation_mc_2_answer_2',
                    'poll_motivation_mc_2_answer_3',
                    'poll_motivation_mc_2_answer_4',
                    'poll_motivation_mc_2_answer_5'
                ]
            }, {
                type: 'open',
            ...
            'satisfaction': createPoll('poll_satisfaction_heading', [{
                ...
                answers: [
                    'poll_satisfaction_mc_1_answer_1',
                    'poll_satisfaction_mc_1_answer_2',
                    'poll_satisfaction_mc_1_answer_3',
                    'poll_satisfaction_mc_1_answer_4',
                    'poll_satisfaction_mc_1_answer_5'
                ]
            }, {
                type: 'smiley',
                ...
                answers: [
                    'poll_satisfaction_mc_2_answer_1',
                    'poll_satisfaction_mc_2_answer_2',
                    'poll_satisfaction_mc_2_answer_3',
                    'poll_satisfaction_mc_2_answer_4',
                    'poll_satisfaction_mc_2_answer_5'
                ]
            }, {
                type: 'single-choice',
