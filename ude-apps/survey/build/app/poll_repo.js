...
(function (ReflectionPoll) {
    ...
    ReflectionPoll.PollRepo = function PollRepo(storageHandler) {
        ...
        function save(poll) {
            return storageHandler.updateResourceAsync(poll.get('id'), poll.toJS()).then(function () {
                // do nothing
            })['catch'](handleStorageError);
        }

        function saveNewPoll() {
            return storageHandler.createResourceAsync(Poll.newPoll().toJS()).then(function (resource) {
                return pollFromResource(resource);
            });
        }
...
//# sourceMappingURL=poll_repo.js.map
