...
(function (ReflectionPoll) {
    var LOAD_ERROR_MSG = 'ConfigHandler: dynamic config not yet loaded, call ' + 'configManager.loadConfig first.';
    ...
    function ConfigHandler(toolName, configDefinition, defaultConfig) {
        ...
        function loadConfig(callback) {
            golab.common.createEnvironmentHandlers('configuration', toolName, 'en', {
        ...
        function writeDynamicConfig(newConfig, callback) {
            ...
            storageHandler.updateResource(dynamicConfig.id, newConfig, setDynamicConfigFromResource.bind(null, callback));
        }
...
//# sourceMappingURL=config_handler.js.map
