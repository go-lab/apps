(function run(actionStatistics) {
    var TOOL_NAME = 'Action Statistics';
    var DOCUMENT_TYPE = 'undefined';
    var FALLBACK_LANGUAGE = 'en';
    var config = golab.tools.configuration.actionStatistics;
    ...
    try {
        ...
        function() {
            ...
            try {
                ...
                actionStatistics.Application(envHandlers, config, loadingIndicator, errorDisplay);
            } catch(error) {
