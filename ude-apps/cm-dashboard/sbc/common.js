...
function loadDataFromJSON(jsonData) {
    ...
    this.title=jsonData.metadata.title;
    this.description=jsonData.metadata.description;
    this.type=jsonData.metadata.type;
    this.directed = jsonData.metadata.directed;
    if(jsonData.metadata.measures!=null)
        this.measures = jsonData.metadata.measures;
    this.datalinks = jsonData.metadata.datalinks;
    if(jsonData.metadata.nodeproperties!=null)
        this.nodeproperties =jsonData.metadata.nodeproperties;
    if(jsonData.metadata.edgeproperties!=null)
        this.edgeproperties =jsonData.metadata.edgeproperties;
...
function loadDataFromFile(dataFile){
