...
(function() {
    "use strict";
    console.log('========== loading libs/expression/js/expression.js');
...
//        printf('unify_deep2 ' + exp);
    ...
    Sine = timo.Sine = function(arg) {
        console.log(JSON.stringify(Functor.Sine,null,4));
...
/**/
    ...
    { var F = function() {}; F.prototype = Divide.prototype; Fraction.prototype = new F(); Fraction.prototype.constructor = Fraction; Fraction.superclass = Divide.prototype; if (Divide.prototype.constructor == Object.prototype.constructor) Divide.prototype.constructor = Divide; };;
...
*/
    ...
    { var F = function() {}; F.prototype = Real.prototype; Irrational.prototype = new F(); Irrational.prototype.constructor = Irrational; Irrational.superclass = Real.prototype; if (Real.prototype.constructor == Object.prototype.constructor) Real.prototype.constructor = Real; };;
    ...
    { var F = function() {}; F.prototype = Real.prototype; Rational.prototype = new F(); Rational.prototype.constructor = Rational; Rational.superclass = Real.prototype; if (Real.prototype.constructor == Object.prototype.constructor) Real.prototype.constructor = Real; };;
...
//        printf('          ' + exp + ' ' + is.Numerical(exp));
    ...
    Variable = timo.Variable = function(str, spec) {
        ...
        this.set_value((spec.value === undefined ? null : spec.value));
        this.type = 'Variable';
...
//              v.updated(true);
    ...
    timo.make_numerical = function(exp) {
        ...
        console.log('timo.make_numerical ' + exp);
        if (is.Numerical(exp))
            return exp;
        if (is.string(exp)) {
            console.log('is.string ' + exp);
            if (exp.match(/[\-+]?[0-9]/)) {
