...
(function() {
    "use strict";
    console.log('========== loading libs/expression/js/timo.js');
    ...
    ng_timo.controller("entry_controller", function($scope) {
        ...
        $scope.parse_entry = function(entry) {
            ...
            try {
                ...
                entry.error = e;
                console.log('toLatex error ' + e);
                console.log('  class_name ' + e.class_name());
            }
        };
    });
    ...
    ng_timo.controller("plotter_controller", function($scope) {
        ...
        $scope.parse_expression = function(expression) {
            ...
            console.log('  class    ' + expr.class_name());
            console.log('  toString ' + expr.toString());
            console.log('  toLatex  ' + expr.toLatex());
            ...
            function do_plot(changed) {
                if (changed) {
                    ...
                    for (var i=0; i<$scope.expressions.length; i++) {
                        ...
                        console.log(tex);
                        console.log($scope.expressions[i].latex);
    ...
    ng_timo.directive("mathjaxBind", function() {
        return {
            ...
            controller: ["$scope", "$element", "$attrs", function($scope, $element, $attrs) {
                console.log('mathjaxBind called for ' + $element[0]);
