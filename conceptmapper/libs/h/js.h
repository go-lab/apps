...
#define extend(sub, super) { var F = function() {}; F.prototype = super.prototype; sub.prototype = new F(); sub.prototype.constructor = sub; sub.superclass = super.prototype; if (super.prototype.constructor == Object.prototype.constructor) super.prototype.constructor = super; };

#define printf(str) console.log(str)

#define pretty_print(obj) console.log(JSON.stringify(obj,null,4))
