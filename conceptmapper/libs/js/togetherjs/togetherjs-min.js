...
(function () {
  ...
  function addStyle() {
    // HACK: load it Go-Lab style in TogetherClient.js
    //golab.common.resourceLoader.orderedLoad([["/libs/js/togetherjs/togetherjs.css"]])
    return
  ...
  var TogetherJS = window.TogetherJS = function TogetherJS(event) {
    ...
    if (typeof TogetherJS.require == "function") {
      // This is an already-configred version of require
    ...
    if (min) {
      ...
      //golab.common.resourceLoader.orderedLoad([["/libs/js/togetherjs/togetherjs.css","/libs/js/togetherjs/togetherjsPackage.js"]])
    } else {
