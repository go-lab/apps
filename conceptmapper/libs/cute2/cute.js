...
(function() {
    ...
    Area.prototype.distance = function(b) {
        ...
        if (ay+ah < by)
        { if (bx+bw < ax)
            return distance(bx+bw, by, ax, ay+ah);
          if (bx > ax+aw)
              return distance(ax+aw, ay+ah, bx, by);
          return by-(ay+ah);
        }

        if (by+bh < ay)
        { if (ax+aw < bx)
            return distance(ax+aw, ay, bx, by+bh);
          if (bx+bw < ax)
              return distance(bx+bw, by+bh, ax, ay);
          return ay-(by+bh);
        }
...
//        printf('Graphical.disconnect: not implemented');	// TBD
    ...
    Graphical.prototype.detach_connection = function(c) {
        ...
        cute.delete_element(gr._connections, c);
        return gr;
    }
...
//        printf('Graphical.in_event_area ' + x + c + y);
//        printf('   a ' + a);
...
(function() {
    ...
    var Drawable = cute.Drawable = function(x, y, w, h) {
        ...
        dr._parts = [];
        dr._closed = false;
        dr._last_point_x = null;
        dr._last_point_y = null;

        return this;
    };

    { var F = function() {}; F.prototype = cute.Graphical.prototype; Drawable.prototype = new F(); Drawable.prototype.constructor = Drawable; Drawable.superclass = cute.Graphical.prototype; if (cute.Graphical.prototype.constructor == Object.prototype.constructor) cute.Graphical.prototype.constructor = cute.Graphical; };;

    Drawable.prototype.toString = function() {
        return "drawable(" + this._id + c + this._name + ")";
    };

    Drawable.prototype.scale = function() {
        var fig = this.figure();

        if (fig instanceof cute.Plane)
            return fig.scale();
        return null;
    }
    ...
    Drawable.prototype.add_moveTo = function(x, y) {
        ...
        dr._parts.push(new geo.Line(x, y, x, y));
...
(function() {
    ...
    { var F = function() {}; F.prototype = cute.Graphical.prototype; Figure.prototype = new F(); Figure.prototype.constructor = Figure; Figure.superclass = cute.Graphical.prototype; if (cute.Graphical.prototype.constructor == Object.prototype.constructor) cute.Graphical.prototype.constructor = cute.Graphical; };;
    ...
    Figure.prototype.erase = function(gr) {
        ...
        if (gr._figure === f) {
            ...
            gr._figure = null;
            cute.delete_element(f._graphicals, gr);
            for (var i=0; i<f._graphicals.length; i) {
    ...
    Figure.prototype.geometry = function(x, y, w, h) {
        ...
        if (x != a._x || y != a._y) {
            ...
            if (!f._offset) {
                console.log('offset for ' + f + ' undefined');
     ...
     */
    Figure.prototype.draw_grid = function(ctx) {
        var fig = this;
        var w = fig.width();
        var h = fig.height();
        var gap = fig._grid;
...
(function() {
    ...
    { var F = function() {}; F.prototype = cute.Graphical.prototype; Circle.prototype = new F(); Circle.prototype.constructor = Circle; Circle.superclass = cute.Graphical.prototype; if (cute.Graphical.prototype.constructor == Object.prototype.constructor) cute.Graphical.prototype.constructor = cute.Graphical; };;
    ...
    { var F = function() {}; F.prototype = Circle.prototype; RadialCircle.prototype = new F(); RadialCircle.prototype.constructor = RadialCircle; RadialCircle.superclass = Circle.prototype; if (Circle.prototype.constructor == Object.prototype.constructor) Circle.prototype.constructor = Circle; };;
...
(function() {
    ...
    { var F = function() {}; F.prototype = cute.Graphical.prototype; Arrow.prototype = new F(); Arrow.prototype.constructor = Arrow; Arrow.superclass = cute.Graphical.prototype; if (cute.Graphical.prototype.constructor == Object.prototype.constructor) cute.Graphical.prototype.constructor = cute.Graphical; };;
...
(function() {
    ...
    { var F = function() {}; F.prototype = cute.Graphical.prototype; Joint.prototype = new F(); Joint.prototype.constructor = Joint; Joint.superclass = cute.Graphical.prototype; if (cute.Graphical.prototype.constructor == Object.prototype.constructor) cute.Graphical.prototype.constructor = cute.Graphical; };;
...
(function() {
    ...
    var Line = cute.Line = function(x1, y1, x2, y2, arrows) {
        ...
        this._start_x = (x1 === undefined ? 0 : x1);
        this._start_y = (y1 === undefined ? 0 : y1);
        this._end_x = (x2 === undefined ? 0 : x2);
        this._end_y = (y2 === undefined ? 0 : y2);
        this._arrows = arrows;

        return this;
    }

    { var F = function() {}; F.prototype = cute.Joint.prototype; Line.prototype = new F(); Line.prototype.constructor = Line; Line.superclass = cute.Joint.prototype; if (cute.Joint.prototype.constructor == Object.prototype.constructor) cute.Joint.prototype.constructor = cute.Joint; };;

    Line.prototype.toString = function() {
        var ln = this;

        return "cute.Line(" + ln._start_x + sep + ln._start_y + sep + ln._end_x + sep + ln._end_y + ")";
    }
...
(function() {
    ...
    { var F = function() {}; F.prototype = cute.Graphical.prototype; Text.prototype = new F(); Text.prototype.constructor = Text; Text.superclass = cute.Graphical.prototype; if (cute.Graphical.prototype.constructor == Object.prototype.constructor) cute.Graphical.prototype.constructor = cute.Graphical; };;
...
(function() {
    ...
    { var F = function() {}; F.prototype = cute.Line.prototype; Connection.prototype = new F(); Connection.prototype.constructor = Connection; Connection.superclass = cute.Line.prototype; if (cute.Line.prototype.constructor == Object.prototype.constructor) cute.Line.prototype.constructor = cute.Line; };;
...
(function() {
    ...
    { var F = function() {}; F.prototype = cute.Graphical.prototype; Ellipse.prototype = new F(); Ellipse.prototype.constructor = Ellipse; Ellipse.superclass = cute.Graphical.prototype; if (cute.Graphical.prototype.constructor == Object.prototype.constructor) cute.Graphical.prototype.constructor = cute.Graphical; };;
...
(function() {
    ...
    { var F = function() {}; F.prototype = cute.Joint.prototype; Path.prototype = new F(); Path.prototype.constructor = Path; Path.superclass = cute.Joint.prototype; if (cute.Joint.prototype.constructor == Object.prototype.constructor) cute.Joint.prototype.constructor = cute.Joint; };;
...
(function() {
    ...
    { var F = function() {}; F.prototype = cute.Gesture.prototype; ResizeGesture.prototype = new F(); ResizeGesture.prototype.constructor = ResizeGesture; ResizeGesture.superclass = cute.Gesture.prototype; if (cute.Gesture.prototype.constructor == Object.prototype.constructor) cute.Gesture.prototype.constructor = cute.Gesture; };;
...
(function() {
    ...
    { var F = function() {}; F.prototype = cute.ConstraintMoveGesture.prototype; ConstraintMoveGesture.prototype = new F(); ConstraintMoveGesture.prototype.constructor = ConstraintMoveGesture; ConstraintMoveGesture.superclass = cute.ConstraintMoveGesture.prototype; if (cute.ConstraintMoveGesture.prototype.constructor == Object.prototype.constructor) cute.ConstraintMoveGesture.prototype.constructor = cute.ConstraintMoveGesture; };;
...
(function() {
 ...
 //  Using HSV (0...360, 0...1, 0...1)
    ...
    Colour.prototype.update = function() {
        ...
        c.rgba({r: c._red, g: c._green, b: c._blue, a: c._alpha});
    ...
    Colour.prototype.red = function(val) {
        if (val === undefined)
            return this._red;
        this._red = val;
        this.update();
    ...
    Colour.prototype.green = function(val) {
        if (val === undefined)
            return this._green;
        this._green = val;
        this.update();
    ...
    Colour.prototype.blue = function(val) {
        if (val === undefined)
            return this._blue;
        this._blue = val;
        this.update();
    ...
    Colour.prototype.alpha = function(val) {
        if (val === undefined)
            return this._alpha;
        this._alpha = val;
        this.update();
    ...
    /**
     *  Makes the colour pct % darker, by just multiplying the RGB values.
     */
    Colour.prototype.darker = function(pct) {
        this._red *= (1-pct/100);
        this._green *= (1-pct/100);
        this._blue *= (1-pct/100);
        this.update();
        return this;
    };
    ...
    /**
     *  Makes the colour pct % lighter, by just multiplying the RGB values.
     */
    Colour.prototype.lighter = function(pct) {
        this._red *= (1+pct/100);
        this._green *= (1+pct/100);
        this._blue *= (1+pct/100);
        this.update();
...
(function() {
    ...
    { var F = function() {}; F.prototype = cute.MoveGesture.prototype; DragDropGesture.prototype = new F(); DragDropGesture.prototype.constructor = DragDropGesture; DragDropGesture.superclass = cute.MoveGesture.prototype; if (cute.MoveGesture.prototype.constructor == Object.prototype.constructor) cute.MoveGesture.prototype.constructor = cute.MoveGesture; };;
